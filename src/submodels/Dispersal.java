...
public class Dispersal {
	...
	public static void initializeDispersal(Model model){
	...
	public static void resetOutgoingRemoteCells(Model model){
	 ...
	 * @param model 
	 * @param template  */
	public static void disperse(LocalCell cell, int nPackets, Uniform unif, NeighborhoodTemplate template){
	...
	public static void finalizeDispersal(Model model){
		for(int row = 0; row < model.parameters.nRows; row++)
		for(int col = 0; col < model.parameters.nCols; col++){
